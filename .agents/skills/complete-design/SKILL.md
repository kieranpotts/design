...
A design change MUST NOT land on `main` until the architecture it describes
...
1.  **Identify the design change.**
    ...
    `main`, use the user's description, or list open design-change pull requests
...
- [`AGENTS.md`](../../../AGENTS.md): The full design-change workflow and the
  "`main` describes production" rule.
